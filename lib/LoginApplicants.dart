...
class LoginApplicants extends StatefulWidget {
    LoginApplicants({super.key});

  @override
  State<LoginApplicants> createState() => _LoginApplicantsState();
}

class _LoginApplicantsState extends State<LoginApplicants> {
       ...
       ElevatedButton (
                      onPressed: () async {
                        bool x;
                         ...
                         if(!mounted) return;
                         if (x){
                          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  homepageapplicant()));
                         }
